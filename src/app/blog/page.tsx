        ...
        <div className="container mx-auto px-6 lg:px-8 max-w-7xl relative z-10">
              ...
              <Link href={`/blog/${featuredPost.slug}`}
                ...
                <div className="grid md:grid-cols-2">
                  ...
                  <div className="p-8 md:p-10 lg:p-14 flex flex-col justify-center">
                    ...
                    <p className="text-black/60 leading-relaxed mb-6 line-clamp-3">
                      {featuredPost.excerpt}
                    </p>
                    <div className="flex items-center gap-4 text-sm text-black/50 mb-6">
          ...
          {filteredPosts.length === 0 && (
            <div className="text-center py-20">
              <p className="text-black/50 text-lg">Bu kategoride henüz yazı bulunmuyor.</p>
            </div>
          )}
        </div>
      </section>
