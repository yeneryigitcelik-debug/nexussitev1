...
function SocialIcon({ children, href, label }: { children: React.ReactNode; href: string; label: string }) {
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" aria-label={label}
      className="flex h-10 w-10 items-center justify-center rounded-full border border-black/[0.08] bg-black/[0.02] text-black/30 transition-all duration-300 hover:border-brand/30 hover:bg-brand/10 hover:text-brand hover:scale-110">
        ...
        <div className="mx-auto max-w-7xl px-6 py-10 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-sm text-black/40">Sigorta haberleri ve özel kampanyalardan haberdar olun.</p>
            </div>
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-6 text-sm leading-relaxed text-black/40">
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+905332516773" className="text-sm text-black/40 transition-colors hover:text-brand">
                  +90 533 251 67 73
                </a>
              </div>
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:info@nexussigorta.com" className="text-sm text-black/40 transition-colors hover:text-brand">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {kurumsalLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href}
                    className="group flex items-center text-sm text-black/40 transition-colors hover:text-brand">
